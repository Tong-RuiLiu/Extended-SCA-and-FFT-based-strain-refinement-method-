...
%% This is the constitutive laws for yarn materials with centerline stretches in the Y direction. 
function[Cglobal]=Elasm3DYarnY(E11,E22,E33,v12,v13,v23,G12,G13,G23,csi,si)
Clocal=zeros(6);
rmx=[0,1,0;csi,0,si;si,0,-csi;];% Yarn2 Yarn3 Yarn4 (YarnY)
%rmx=[0,-1,0;csi,0,-si;si,0,csi;];% Yarn2 Yarn3 Yarn4 (YarnY)
